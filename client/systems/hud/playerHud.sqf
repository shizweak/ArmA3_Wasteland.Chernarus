...
while {true} do
{
	...
	_serverString = format ["<t color='#A0FFFFFF'>Shizweak #%1 A3Wasteland %2 : Server</t>", call A3W_extDB_ServerID, worldName];
	_serverString = format ["%1<br/><t color='#A0FFFFFF'>shizweak.es:64738 : Mumble<br/>www.shizweak.es : Website/Forum</t>",_serverString];
	...
	{
		_tempString = format ["<t color='#A0FFFFFF'>Shizweak A3Wasteland %1<br/>www.www.shizweak.es</t>", getText (configFile >> "CfgWorlds" >> worldName >> "description")];
		_yOffset = 0.28;
